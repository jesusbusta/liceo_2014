      ...
      <table width="100%" height="192" align="center">
        <tr>
          <td height="186" align="center" valign="middle"><div>
            <form name="form1" method="post" action="eliminar_alumno2.php">
              ...
              <p>
                <input type="submit" class="btn btn-info" name="button3" id="button3" value="Eliminar"> <a href="menu_administrador.php" role="button" class="btn btn-info"><i class="icon-align-justify icon-white"></i> Menu</a>
                </p>
            </form>
