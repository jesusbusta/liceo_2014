  ...
  <tr>
    <td height="146" valign="top"><div>
      <table width="100%" height="66" border="1" class="table table-bordered">
        <tr class="info">
<td><h3> <img src="imagenes_DR_A.U.P/imagen-grado.jpg" width="100" height="100" class="img-circle img-polaroid"> Registro de Grado o Año</h3></td>
        </tr>
      </table>
      <form action="registro_grado2.php" method="post" name="form1" onSubmit="MM_validateForm('fecha1','','R','Fecha_ini','','R');return document.MM_returnValue">
        <table width="100%" border="1" class="table table-bordered table-hover"	>
          <tr>
            <td width="789"><center>
              <strong>Ejemplo:(septimo)</strong>
              <label for="GRADO"></label>
              <input class="input-medium"" type="text" name="GRADO" id="GRADO">
              </center></td>
          </tr>
          </table>
        <p>&nbsp;</p>
