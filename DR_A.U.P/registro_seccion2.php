...
//insertar
$insertar = "INSERT INTO seccion(nombre_seccion) VALUES ('".$s1."')";
...
echo '<center><table width="100%"  align="center">
 ...
 ?>
      ...
      <p>&nbsp;</p>
      <p><center>
        <a href="registro_seccion.php" role="button" class="btn btn-info">Regresar</a>  <a href="menu_administrador.php" role="button" class="btn btn-info"> Menu</a></center></p>
    </div></td>
  </tr>
</table>
<p>&nbsp;</p>
