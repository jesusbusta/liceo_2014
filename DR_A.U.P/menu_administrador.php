  ...
  <tr>
    <td height="146" valign="top"><div>
      <table width="100%" height="66" border="1" class="table table-bordered">
        <tr class="info">
<td><center><h3><img src="imagenes_DR_A.U.P/encabezadoliceo.png"></h3></center></td>
        </tr>
      </table>
...
<li>
<a href="Index.html" role="button"><i class="icon-home"></i>Salir</a>         
</li>
</ul>
</div>
</div>
          ...
          <tr>
            <td><p>&nbsp;</p>
              <p><center>
              <img src="imagenes_DR_A.U.P/icono-administrador.jpg" width="217" height="194" class="img-circle img-polaroid"><strong><h3>Bienvenido al Sistema (S.A.P.R.C.N)</h3></strong></td>
          </tr>
        </table>
        <p>&nbsp;</p>
      <p>&nbsp;</p>
