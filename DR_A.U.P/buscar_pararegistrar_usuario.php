  ...
  <tr>
    <td height="388" valign="top"><div>
      <table width="100%" height="66" border="1" class="table table-bordered">
        <tr class="info">
<td><h3><img src="imagenes_DR_A.U.P/usuarios.png" width="100" height="91" class="img-circle img-polaroid"> Datos del Usuario</h3></td>
        </tr>
      </table>
      <table width="100%" height="192" align="center">
        <tr>
          <td height="186" align="center" valign="middle"><div>
            <form name="form1" method="post" action="buscar_pararegistrar_usuario2.php">
